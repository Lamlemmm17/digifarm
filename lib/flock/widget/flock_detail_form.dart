...
class FlockDetailForm extends ConsumerStatefulWidget {
  const FlockDetailForm(this.flock, {super.key});

  final Flock flock;

  @override
  ConsumerState<FlockDetailForm> createState() => _FlockDetailFormState();
}

class _FlockDetailFormState extends ConsumerState<FlockDetailForm> {
  ...
  @override
  void initState() {
    _idKandang = widget.flock.id;
    _tipeKandang = widget.flock.tipeKandang;
    _ternakDiisi = widget.flock.hewanTernak;
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    final dombaTersedia = ref.watch(flockLambsProvider(_idKandang));
